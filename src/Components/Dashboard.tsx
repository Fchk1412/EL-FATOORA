          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                ...
                <div className="text-lg font-semibold text-blue-600">ElFatoura</div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4 rounded-lg text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{stats.monthlyRevenue.toFixed(2)} TND</p>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">Add, edit, and manage your company's clients for quick invoice generation.</p>
          ...
          >
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">Add or update products, prices, and tax details for your invoices.</p>
          ...
          >
            <div className="p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Create Invoices</h3>
              <p className="text-gray-600 text-sm mb-4">Generate new invoices with pre-filled client and product information.</p>
        ...
        <div className="mt-6 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-blue-700 font-medium">Add New Client</span>
            </Link>
            ...
            >
              ...
              <span className="text-purple-700 font-medium">Create Invoice</span>
            </Link>
